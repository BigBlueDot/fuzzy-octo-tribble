...
{
    public class DummyCombatStatus : ICombatStatus
    {
        public DummyCombatStatus(string currentCharacter, IEnumerable<IEffect> effects, IEnumerable<ICharacterDisplay> characterDisplays, IEnumerable<ICharacterDisplay> npcDisplays)
        {
